package com.redravencomputing.devslopesradio.fragments;
...
import com.redravencomputing.devslopesradio.adapters.StationsAdapter;
import com.redravencomputing.devslopesradio.services.DataService;
...
public class StationsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(stationType == STATION_TYPE_FEATURED) {
            adapter = new StationsAdapter(DataService.getInstance().getFeatureStations());
